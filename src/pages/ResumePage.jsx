    ...
    <AnimatePresence mode="wait">
      {isLoading ? (
        ...
        >
          ...
          {/* Resume Card */}
          <motion.div
            className="resume-card glassmorphic reveal"
          ...
          >
            ...
            <div className="resume-section reveal" style={{ marginBottom: '2.5rem' }}>
              <h3 className="resume-section-title" style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            {/* Experience */}
            <div className="resume-section reveal" style={{ marginBottom: '2.5rem' }}>
              <h3 className="resume-section-title" style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                {resumeData.experience.map((exp, i) => (
                  <div key={i} className="resume-entry">
                    <div className="resume-entry-header" style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', marginBottom: '0.75rem' }}>
                      <div>
                        <div className="resume-entry-role" style={{ fontSize: '1.15rem', fontWeight: 700 }}>{exp.role}</div>
                ...
                {resumeData.education.map((edu, i) => (
                  <div key={i} className="resume-entry">
                    <div className="resume-entry-header" style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                      <div>
                        <div className="resume-entry-role" style={{ fontSize: '1.1rem', fontWeight: 700 }}>{edu.degree}</div>
            ...
            <div className="resume-section reveal">
              ...
              <div className="resume-achievements" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
                {resumeData.achievements.map((ach, i) => (
                  <div key={i} className="resume-achievement" style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '1rem', border: '1px solid var(--border)', borderRadius: 12, fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
